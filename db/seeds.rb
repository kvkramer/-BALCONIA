...
Sphere.create!(title: "Cozy Living Room", address: "Berlin", price: 10, user_id: user.id, barbecue: true, balcony: true, garden: false, terrace: true, plants: true, quiet: false, sunny: true, spacious_desk: false, highspeed_wifi: true, pet_friendly: false, cozy: true)
